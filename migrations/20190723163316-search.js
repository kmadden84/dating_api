...
const searchObjects = {
  Users: ['fav_movie','fav_song', 'gender', 'looking_for', 'drinking', 'education', 'build', 'living_status', 'age', 'ideal_vaca', 'fav_cheese', 'fav_timeofday', 'fav_mov_genre', 'fav_weather', 'fav_drink', 'fav_cuisine']
};
